...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
      ...
      {/* Hero Section */}
      <div className="flex flex-col justify-center items-center py-40 text-center text-white max-w-6xl mx-auto">
      ...
      <div className="bg-black text-white py-40">
        <div className="flex max-w-6xl mx-auto justify-center items-center flex-col md:flex-row px-4 md:px-2">
          {/* left */}
